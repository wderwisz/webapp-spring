package com.example.microservices.profession_management_service.services;

import com.example.microservices.profession_management_service.DTO.ProfessionCollectionDto;
...
import com.example.microservices.profession_management_service.repositories.ProfessionRepository;
...
//        return professionRepository.save(newProfession);
    ...
    @Transactional
    public void deleteProfessionByName(String name) {
        professionRepository.deleteByName(name);
    }
